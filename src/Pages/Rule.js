...
import bg from '../component/Assets/Vector.png'
...
function Rule() {
  return (
    <div style={{ backgroundImage: `url(${bg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}} className='container mx-auto bg-mobi-pinl h-screen w-full overflow-x-hidden overflow-y-scroll'>
        ...
        <div className='text-white mt-4 px-2 w-full'>
            <ul className='w-full'>
                ...
                <li className='flex items-center mt-5'>
                    <div className='bg-red-500 rounded-xl'>
                        <img className='w-12 h-12' src={Santa} />
                    </div>
            ...
            <h1 className='mt-5'>Жишээ нь: 4 гишүүнтэй гэр бүл Санта буух магадлал 34%Олаф буух магадлал 40% Гринч буух магадлал 26%</h1>
